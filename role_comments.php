...
$grid["caption"] = "التعليق على الدور الدولي أو الإقليمي";
$grid["autowidth"] = true;
...
$col["editrules"] = array("required"=>false);
$col["formatter"] = "select"; // display label, not value
$col["editoptions"] = array("value"=>":;"."دولي:دولي;إفليمي:إفليمي");
$cols[] = $col;



$col = array();
$col["title"] = "التعليق"; // caption of column
$col["name"] = "comment";
$col["width"] = "200";
$col["editable"] = true;
