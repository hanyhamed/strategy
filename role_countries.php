...
$sql="UPDATE `countries` set `country2`='". $data["params"]["country1"]."' WHERE `id`={$data['id']}";
...
<body style="background:#F7F7F7">
 ...
 <div class="nav-links">
		  ...
		  <li><a href="role_comments.php">التعليق على الأدوار</a>
		  </li><li><a href="logout.php">خروج</a></li>	  	 
          <a class="icon">
